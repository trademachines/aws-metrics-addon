...
const extractMetricsWithDebug = (event, instances, cb) => {
  console.log('instance-based-metrics', JSON.stringify(event),
...
const getContainerInstancesDescription = (ecs, eventInfo,
                                          containerInstancesData, cb) => {
  const params = {
...
module.exports.getContainerInstancesDescription =
  getContainerInstancesDescription;
